...
- main:
    ...
    - heading "Result:" [level=5]
    - text: "\"Added goal \\\"Test Goal\\\" to workflow (ID: goal-1752465090996-awltjgpov). You can now add tasks, constraints, and policies to this goal.\""
    - button "addTask ✓ Completed":
        - img
        - heading "addTask ✓ Completed" [level=4]
        - img
    - heading "Arguments:" [level=5]
    - text: '{ "goalId": "goal-1752465090996-awltjgpov", "description": "Validate input data", "assigneeType": "ai_agent" }'
    - heading "Result:" [level=5]
    - text: "\"Added ai_agent task \\\"Validate input data\\\" to goal \\\"Test Goal\\\". Task will run indefinitely.\""
    - button "addTask ✓ Completed":
        - img
        - heading "addTask ✓ Completed" [level=4]
        - img
    - heading "Arguments:" [level=5]
    - text: '{ "goalId": "goal-1752465090996-awltjgpov", "description": "Process data", "assigneeType": "ai_agent" }'
    - heading "Result:" [level=5]
    - text: "\"Added ai_agent task \\\"Process data\\\" to goal \\\"Test Goal\\\". Task will run indefinitely.\""
    - button "addTask ✓ Completed":
        - img
        - heading "addTask ✓ Completed" [level=4]
        - img
    - heading "Arguments:" [level=5]
    - text: '{ "goalId": "goal-1752465090996-awltjgpov", "description": "Send notification", "assigneeType": "ai_agent" }'
    - heading "Result:" [level=5]
    - text: "\"Added ai_agent task \\\"Send notification\\\" to goal \\\"Test Goal\\\". Task will run indefinitely.\""
    - paragraph: 'The "Test Workflow" has been successfully created with the goal "Test Goal," which includes the following tasks:'
    - list:
        - listitem:
            - strong: Validate input data
            - text: "- Assigned to an AI agent."
        - listitem:
            - strong: Process data
            - text: "- Assigned to an AI agent."
        - listitem:
    ...
    - 'heading "Goal 7: Test Goal" [level=3]'
    - paragraph: A goal to test the addition of tasks within a workflow.
    - text: 0 Constraints 0 Policies 0 Tasks 0 Forms ⏳
    - 'heading "Goal 8: Test Goal" [level=3]'
    - paragraph: A goal to test the addition of tasks within a workflow.
    - text: 0 Constraints 0 Policies 0 Tasks 0 Forms
